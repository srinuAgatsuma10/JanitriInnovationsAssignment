...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		sparkReporter.config().setDocumentTitle("Janitri Innovations Report"); // Title of report
		sparkReporter.config().setReportName("Janitri Login Functionality Testing"); // name of the report
